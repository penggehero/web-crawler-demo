...
public interface CourseCategoryMapper {
    ...
    List<CourseCategory> queryByLevel(@Param("date") Date date, @Param("level") int level);

    List<CourseCategory> queryByDate(Date date);
     ...
     * @return 实例对象
     */
    CourseCategory queryById(Object id);
